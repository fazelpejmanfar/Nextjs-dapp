...
export const contractChainId = 5; // 1 for Eth Mainnet, 5 for eth GOERLI


export const projectId = "ea12f987ea5f2430cacb522ebb6a369a"; // get it from wallet connect website
